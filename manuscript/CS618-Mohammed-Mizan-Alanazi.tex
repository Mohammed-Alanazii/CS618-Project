...
\dataavailability{The NinaPro DB2 dataset is publicly available at \url{https://ninapro.hevs.ch/}. The code and filtered data subset used in this paper are available from the corresponding author upon reasonable request.}
